...
-- Faction name
CF.FactionNames[factionid] = "Space Wolves"
-- Faction description
...
-- Define brain unit
CF.BrainPresets[factionid] = "Space Wolves Assault Sergeant Brain"
CF.BrainModules[factionid] = "w40k.rte"
CF.BrainClasses[factionid] = "AHuman"
CF.BrainPrices[factionid] = 500

-- Define dropship
CF.CraftPresets[factionid] = "Space Wolves Drop Pod"
...
CF.ActNames[factionid][i] = "Wolf Scout"
CF.ActPresets[factionid][i] = "Wolf Scout"
...
i = #CF.ActNames[factionid] + 1
CF.ActNames[factionid][i] = "Wolf Assault Recon"
CF.ActPresets[factionid][i] = "Wolf Assault Recon"
CF.ActModules[factionid][i] = "w40k.rte"
...
i = #CF.ActNames[factionid] + 1
CF.ActNames[factionid][i] = "Blood Claw"
CF.ActPresets[factionid][i] = "Blood Claw"
CF.ActModules[factionid][i] = "w40k.rte"
...
CF.ActUnlockData[factionid][i] = 750 -- 0 means available at start
CF.ActTypes[factionid][i] = CF.ActorTypes.HEAVY
CF.ActPowers[factionid][i] = 0

i = #CF.ActNames[factionid] + 1
CF.ActNames[factionid][i] = "Grey Hunter"
CF.ActPresets[factionid][i] = "Grey Hunter"
CF.ActModules[factionid][i] = "w40k.rte"
...
i = #CF.ActNames[factionid] + 1
CF.ActNames[factionid][i] = "Skyclaw"
CF.ActPresets[factionid][i] = "Skyclaw"
CF.ActModules[factionid][i] = "w40k.rte"
CF.ActPrices[factionid][i] = 300
CF.ActDescriptions[factionid][i] =
...
if CF.BombNames ~= nil then
	...
	CF.BombOwnerFactions[n] = { "Imperium of Man: Space Wolves" }

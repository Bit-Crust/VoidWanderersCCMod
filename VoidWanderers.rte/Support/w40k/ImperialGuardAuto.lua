-- Unique Faction ID
local factionid = "Imperium of Man: Imperial Guard with Autoweapons"
print("Loading " .. factionid)

CF["Factions"][#CF["Factions"] + 1] = factionid

-- Faction name
CF["FactionNames"][factionid] = "Imperial Guard with Autoweapons"
-- Faction description
...
CF["ScanBonuses"][factionid] = 10
-- Relation points increase
CF["RelationsBonuses"][factionid] = -50
-- Hew HQ build price reduction
CF["ExpansionBonuses"][factionid] = -25

-- Gold per turn increase
CF["MineBonuses"][factionid] = -10
-- Science per turn increase
CF["LabBonuses"][factionid] = -10
-- Delivery time reduction
CF["AirfieldBonuses"][factionid] = 25
-- Superweapon targeting reduction
CF["SuperWeaponBonuses"][factionid] = 25
-- Unit price reduction
CF["FactoryBonuses"][factionid] = 25
-- Body price reduction
CF["CloneBonuses"][factionid] = 25
...
CF["SuperWeaponScripts"][factionid] = "w40k.rte/Other Mod Support/UnmappedLands2/SuperWeapons/Thudd Mortars.lua"
...
i = #CF["ItmNames"][factionid] + 1
CF["ItmNames"][factionid][i] = "Machine Pistol"
CF["ItmPresets"][factionid][i] = "Machine Pistol"
CF["ItmModules"][factionid][i] = "w40k.rte"
CF["ItmPrices"][factionid][i] = 25
CF["ItmDescriptions"][factionid][i] =
	"Compact autopistol with foregrip, a moderately effective weapon of last resort. Very high rate of fire and high potential lethality, but very poor armour penetration. Best used against poorly armoured targets like cultists and undead. Don't bother using it against, say, Space Marines, or Dummy Dreadnaughts."
CF["ItmUnlockData"][factionid][i] = 250 -- 0 means available at start
CF["ItmTypes"][factionid][i] = CF["WeaponTypes"].PISTOL
CF["ItmPowers"][factionid][i] = 1

i = #CF["ItmNames"][factionid] + 1
CF["ItmNames"][factionid][i] = "Stub Semi-Auto"
CF["ItmPresets"][factionid][i] = "Stub Semi-Auto"
CF["ItmModules"][factionid][i] = "w40k.rte"
CF["ItmPrices"][factionid][i] = 35
CF["ItmDescriptions"][factionid][i] =
	"A sturdy and reliable semi-automatic sidearm. Lower capacity than the Machine Pistol, but superior penetration."
CF["ItmUnlockData"][factionid][i] = 0 -- 0 means available at start
CF["ItmTypes"][factionid][i] = CF["WeaponTypes"].PISTOL
CF["ItmPowers"][factionid][i] = 3

i = #CF["ItmNames"][factionid] + 1
CF["ItmNames"][factionid][i] = "Stub Revolver"
CF["ItmPresets"][factionid][i] = "Stub Revolver"
CF["ItmModules"][factionid][i] = "w40k.rte"
CF["ItmPrices"][factionid][i] = 50
CF["ItmDescriptions"][factionid][i] = "A heavy duty six-round revolver, very powerful and very deadly."
...
i = #CF["ItmNames"][factionid] + 1
CF["ItmNames"][factionid][i] = "Imperium Carbine"
CF["ItmPresets"][factionid][i] = "Imperium Carbine"
CF["ItmModules"][factionid][i] = "w40k.rte"
CF["ItmPrices"][factionid][i] = 45
CF["ItmDescriptions"][factionid][i] =
	"A compact carbine with decent firepower, accuracy, and range. Fires in short bursts."
CF["ItmUnlockData"][factionid][i] = 250 -- 0 means available at start
CF["ItmTypes"][factionid][i] = CF["WeaponTypes"].RIFLE
CF["ItmPowers"][factionid][i] = 3

i = #CF["ItmNames"][factionid] + 1
CF["ItmNames"][factionid][i] = "Imperium Autogun"
CF["ItmPresets"][factionid][i] = "Imperium Autogun"
CF["ItmModules"][factionid][i] = "w40k.rte"
CF["ItmPrices"][factionid][i] = 65
CF["ItmDescriptions"][factionid][i] =
	"A heavy slugthrowing rifle, usually employed by thugs, cultists, and underequipped Guardsmen."
CF["ItmUnlockData"][factionid][i] = 0 -- 0 means available at start
CF["ItmTypes"][factionid][i] = CF["WeaponTypes"].RIFLE
CF["ItmPowers"][factionid][i] = 6

i = #CF["ItmNames"][factionid] + 1
CF["ItmNames"][factionid][i] = "Imperium Autogun with Grenade Launcher"
CF["ItmPresets"][factionid][i] = "Imperium Autogun with Grenade Launcher"
CF["ItmModules"][factionid][i] = "w40k.rte"
CF["ItmPrices"][factionid][i] = 80
CF["ItmDescriptions"][factionid][i] =
	"A heavy slugthrowing rifle, usually employed by thugs, cultists, and underequipped Guardsmen. This variant possesses a light underbarrel grenade launcher fired with the 'F' key."
CF["ItmUnlockData"][factionid][i] = 500 -- 0 means available at start
CF["ItmTypes"][factionid][i] = CF["WeaponTypes"].RIFLE
CF["ItmPowers"][factionid][i] = 0

i = #CF["ItmNames"][factionid] + 1
CF["ItmNames"][factionid][i] = "Imperium Heavy Stubber"
CF["ItmPresets"][factionid][i] = "Imperium Heavy Stubber"
CF["ItmModules"][factionid][i] = "w40k.rte"
CF["ItmPrices"][factionid][i] = 175
CF["ItmDescriptions"][factionid][i] =
	"1200rpm and 100 rounds of heavy anti-infantry firepower. Often mounted on vehicles to minimize recoil."
CF["ItmUnlockData"][factionid][i] = 1500 -- 0 means available at start
CF["ItmTypes"][factionid][i] = CF["WeaponTypes"].RIFLE
CF["ItmPowers"][factionid][i] = 7
...
i = #CF["ItmNames"][factionid] + 1
CF["ItmNames"][factionid][i] = "Guard Sniper Rifle"
CF["ItmPresets"][factionid][i] = "Guard Sniper Rifle"
CF["ItmModules"][factionid][i] = "w40k.rte"
CF["ItmPrices"][factionid][i] = 80
CF["ItmDescriptions"][factionid][i] =
	"A five-round semi-automatic sniper rifle, effective against mid-range targets. Best used against lighter infantry, as it lacks the power to be truly effective against well-armoured enemies."
...
if CF["BombNames"] ~= nil then
	...
	CF["BombOwnerFactions"][n] = { "Imperium of Man: Imperial Guard with Autoweapons" }

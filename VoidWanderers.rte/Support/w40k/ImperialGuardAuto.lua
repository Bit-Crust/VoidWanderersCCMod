...
-- Faction name
CF_FactionNames[factionid] = "Imperial Guard with Autoweapons"
-- Faction description
...
CF_SuperWeaponScripts[factionid] = "w40k.rte/Other Mod Support/UnmappedLands2/SuperWeapons/Thudd Mortars.lua"
...
i = #CF_ItmNames[factionid] + 1
CF_ItmNames[factionid][i] = "Machine Pistol"
CF_ItmPresets[factionid][i] = "Machine Pistol"
CF_ItmModules[factionid][i] = "w40k.rte"
...
i = #CF_ItmNames[factionid] + 1
CF_ItmNames[factionid][i] = "Stub Semi-Auto"
CF_ItmPresets[factionid][i] = "Stub Semi-Auto"
CF_ItmModules[factionid][i] = "w40k.rte"
...
i = #CF_ItmNames[factionid] + 1
CF_ItmNames[factionid][i] = "Stub Revolver"
CF_ItmPresets[factionid][i] = "Stub Revolver"
CF_ItmModules[factionid][i] = "w40k.rte"
CF_ItmPrices[factionid][i] = 50
CF_ItmDescriptions[factionid][i] = "A heavy duty six-round revolver, very powerful and very deadly."
...
i = #CF_ItmNames[factionid] + 1
CF_ItmNames[factionid][i] = "Imperium Carbine"
CF_ItmPresets[factionid][i] = "Imperium Carbine"
CF_ItmModules[factionid][i] = "w40k.rte"
...
i = #CF_ItmNames[factionid] + 1
CF_ItmNames[factionid][i] = "Imperium Autogun"
CF_ItmPresets[factionid][i] = "Imperium Autogun"
CF_ItmModules[factionid][i] = "w40k.rte"
...
i = #CF_ItmNames[factionid] + 1
CF_ItmNames[factionid][i] = "Imperium Autogun with Grenade Launcher"
CF_ItmPresets[factionid][i] = "Imperium Autogun with Grenade Launcher"
CF_ItmModules[factionid][i] = "w40k.rte"
...
i = #CF_ItmNames[factionid] + 1
CF_ItmNames[factionid][i] = "Imperium Heavy Stubber"
CF_ItmPresets[factionid][i] = "Imperium Heavy Stubber"
CF_ItmModules[factionid][i] = "w40k.rte"
CF_ItmPrices[factionid][i] = 175
CF_ItmDescriptions[factionid][i] =
...
i = #CF_ItmNames[factionid] + 1
CF_ItmNames[factionid][i] = "Guard Sniper Rifle"
CF_ItmPresets[factionid][i] = "Guard Sniper Rifle"
CF_ItmModules[factionid][i] = "w40k.rte"
CF_ItmPrices[factionid][i] = 80
CF_ItmDescriptions[factionid][i] =
...
if CF_BombNames ~= nil then
	...
	CF_BombOwnerFactions[n] = { "Imperium of Man: Imperial Guard with Autoweapons" }

-- Unique Faction ID
local factionid = "Imperium of Man: Dark Angels"
print("Loading " .. factionid)

CF_Factions[#CF_Factions + 1] = factionid

-- Faction name
CF_FactionNames[factionid] = "Dark Angels"
-- Faction description
CF_FactionDescriptions[factionid] =
	"First Legion of the twenty, the Dark Angels may have lost their Homeworld of Caliban to the forces of Chaos, but they fight on in the name of the Emperor. They are one of the most religious of the Chapters, with most 'free' time given over to worship and prayer."
...
-- Define brain unit
CF_Brains[factionid] = "Dark Angels Assault Sergeant Brain"
CF_BrainModules[factionid] = "w40k.rte"
CF_BrainClasses[factionid] = "AHuman"
CF_BrainPrices[factionid] = 500

-- Define dropship
CF_Crafts[factionid] = "Dark Angels Drop Pod"
...
CF_ActNames[factionid][i] = "Dark Angels Scout"
CF_ActPresets[factionid][i] = "Dark Angels Scout"
...
i = #CF_ActNames[factionid] + 1
CF_ActNames[factionid][i] = "Dark Angels Assault Recon"
CF_ActPresets[factionid][i] = "Dark Angels Assault Recon"
CF_ActModules[factionid][i] = "w40k.rte"
...
i = #CF_ActNames[factionid] + 1
CF_ActNames[factionid][i] = "Dark Angels Space Marine"
CF_ActPresets[factionid][i] = "Dark Angels Space Marine"
CF_ActModules[factionid][i] = "w40k.rte"
...
i = #CF_ActNames[factionid] + 1
CF_ActNames[factionid][i] = "Dark Angels Assault Marine"
CF_ActPresets[factionid][i] = "Dark Angels Assault Marine"
CF_ActModules[factionid][i] = "w40k.rte"
...
if CF_BombNames ~= nil then
	...
	CF_BombOwnerFactions[n] = { "Imperium of Man: Dark Angels" }

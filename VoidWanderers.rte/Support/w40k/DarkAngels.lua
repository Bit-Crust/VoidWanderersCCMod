...
-- Faction name
CF.FactionNames[factionid] = "Dark Angels"
-- Faction description
...
-- Define brain unit
CF.BrainPresets[factionid] = "Dark Angels Assault Sergeant Brain"
CF.BrainModules[factionid] = "w40k.rte"
CF.BrainClasses[factionid] = "AHuman"
CF.BrainPrices[factionid] = 500

-- Define dropship
CF.CraftPresets[factionid] = "Dark Angels Drop Pod"
...
CF.ActNames[factionid][i] = "Dark Angels Scout"
CF.ActPresets[factionid][i] = "Dark Angels Scout"
...
i = #CF.ActNames[factionid] + 1
CF.ActNames[factionid][i] = "Dark Angels Assault Recon"
CF.ActPresets[factionid][i] = "Dark Angels Assault Recon"
CF.ActModules[factionid][i] = "w40k.rte"
...
i = #CF.ActNames[factionid] + 1
CF.ActNames[factionid][i] = "Dark Angels Space Marine"
CF.ActPresets[factionid][i] = "Dark Angels Space Marine"
CF.ActModules[factionid][i] = "w40k.rte"
...
i = #CF.ActNames[factionid] + 1
CF.ActNames[factionid][i] = "Dark Angels Assault Marine"
CF.ActPresets[factionid][i] = "Dark Angels Assault Marine"
CF.ActModules[factionid][i] = "w40k.rte"
...
if CF.BombNames ~= nil then
	...
	CF.BombOwnerFactions[n] = { "Imperium of Man: Dark Angels" }

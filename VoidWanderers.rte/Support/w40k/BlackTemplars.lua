-- Unique Faction ID
local factionid = "Imperium of Man: Black Templars"
print("Loading " .. factionid)

CF_Factions[#CF_Factions + 1] = factionid

-- Faction name
CF_FactionNames[factionid] = "Black Templars"
-- Faction description
CF_FactionDescriptions[factionid] =
	"A Second Founding Chapter derived from the Imperial Fists, the Black Templars are on a never-ending crusade across the galaxy. They are the largest Chapter of all, with as many as 6,000 battle-brothers in total."
...
-- Define brain unit
CF_Brains[factionid] = "Black Templars Assault Sergeant Brain"
CF_BrainModules[factionid] = "w40k.rte"
CF_BrainClasses[factionid] = "AHuman"
CF_BrainPrices[factionid] = 500

-- Define dropship
CF_Crafts[factionid] = "Black Templars Drop Pod"
...
CF_ActNames[factionid][i] = "Black Templar Scout"
CF_ActPresets[factionid][i] = "Black Templar Scout"
...
CF_ActUnlockData[factionid][i] = 1 -- 0 means available at start
CF_ActTypes[factionid][i] = CF_ActorTypes.LIGHT
CF_ActPowers[factionid][i] = 0

i = #CF_ActNames[factionid] + 1
CF_ActNames[factionid][i] = "Black Templar Assault Recon"
CF_ActPresets[factionid][i] = "Black Templar Assault Recon"
CF_ActModules[factionid][i] = "w40k.rte"
...
i = #CF_ActNames[factionid] + 1
CF_ActNames[factionid][i] = "Black Templars Space Marine"
CF_ActPresets[factionid][i] = "Black Templars Space Marine"
CF_ActModules[factionid][i] = "w40k.rte"
...
i = #CF_ActNames[factionid] + 1
CF_ActNames[factionid][i] = "Black Templars Assault Marine"
CF_ActPresets[factionid][i] = "Black Templars Assault Marine"
CF_ActModules[factionid][i] = "w40k.rte"
CF_ActPrices[factionid][i] = 375
CF_ActDescriptions[factionid][i] =
...
CF_ActUnlockData[factionid][i] = 1250 -- 0 means available at start
CF_ActTypes[factionid][i] = CF_ActorTypes.HEAVY
...
if CF_BombNames ~= nil then
	...
	CF_BombOwnerFactions[n] = { "Imperium of Man: Black Templars" }

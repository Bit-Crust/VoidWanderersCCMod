...
-- Faction name
CF["FactionNames"][factionid] = "Black Templars"
-- Faction description
...
CF["ActNames"][factionid][i] = "Black Templar Scout"
CF["ActPresets"][factionid][i] = "Black Templar Scout"
...
CF["ActUnlockData"][factionid][i] = 1 -- 0 means available at start
CF["ActTypes"][factionid][i] = CF["ActorTypes"].LIGHT
CF["ActPowers"][factionid][i] = 0

i = #CF["ActNames"][factionid] + 1
CF["ActNames"][factionid][i] = "Black Templar Assault Recon"
CF["ActPresets"][factionid][i] = "Black Templar Assault Recon"
CF["ActModules"][factionid][i] = "w40k.rte"
...
i = #CF["ActNames"][factionid] + 1
CF["ActNames"][factionid][i] = "Black Templars Space Marine"
CF["ActPresets"][factionid][i] = "Black Templars Space Marine"
CF["ActModules"][factionid][i] = "w40k.rte"
...
i = #CF["ActNames"][factionid] + 1
CF["ActNames"][factionid][i] = "Black Templars Assault Marine"
CF["ActPresets"][factionid][i] = "Black Templars Assault Marine"
CF["ActModules"][factionid][i] = "w40k.rte"
...
if CF["BombNames"] ~= nil then
	...
	CF["BombOwnerFactions"][n] = { "Imperium of Man: Black Templars" }

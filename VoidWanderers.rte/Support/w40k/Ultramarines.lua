-- Unique Faction ID
local factionid = "Imperium of Man: Ultramarines"
print("Loading " .. factionid)

CF_Factions[#CF_Factions + 1] = factionid

-- Faction name
CF_FactionNames[factionid] = "Ultramarines"
-- Faction description
CF_FactionDescriptions[factionid] =
	"The Ultramarines, thirteenth Legion of the original twenty, before the reorganization. The Ultramarines adhere closely to the Codex Astartes, making them a 'middle of the road' faction, at least compared to the other Space Marine Chapters."
...
-- Define brain unit
CF_Brains[factionid] = "Ultramarines Assault Sergeant Brain"
CF_BrainModules[factionid] = "w40k.rte"
CF_BrainClasses[factionid] = "AHuman"
CF_BrainPrices[factionid] = 500

-- Define dropship
CF_Crafts[factionid] = "Ultramarines Drop Pod"
...
CF_ActNames[factionid][i] = "Ultramarine Scout"
CF_ActPresets[factionid][i] = "Ultramarine Scout"
...
i = #CF_ActNames[factionid] + 1
CF_ActNames[factionid][i] = "Ultramarine Assault Recon"
CF_ActPresets[factionid][i] = "Ultramarine Assault Recon"
CF_ActModules[factionid][i] = "w40k.rte"
...
i = #CF_ActNames[factionid] + 1
CF_ActNames[factionid][i] = "Ultramarine"
CF_ActPresets[factionid][i] = "Ultramarine"
CF_ActModules[factionid][i] = "w40k.rte"
...
i = #CF_ActNames[factionid] + 1
CF_ActNames[factionid][i] = "Assault Ultramarine"
CF_ActPresets[factionid][i] = "Assault Ultramarine"
CF_ActModules[factionid][i] = "w40k.rte"
...
if CF_BombNames ~= nil then
	...
	CF_BombOwnerFactions[n] = { "Imperium of Man: Ultramarines" }

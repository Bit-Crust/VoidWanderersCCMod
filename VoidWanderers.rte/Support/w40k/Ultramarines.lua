...
-- Faction name
CF.FactionNames[factionid] = "Ultramarines"
-- Faction description
...
-- Define brain unit
CF.BrainPresets[factionid] = "Ultramarines Assault Sergeant Brain"
CF.BrainModules[factionid] = "w40k.rte"
CF.BrainClasses[factionid] = "AHuman"
CF.BrainPrices[factionid] = 500

-- Define dropship
CF.CraftPresets[factionid] = "Ultramarines Drop Pod"
...
CF.ActNames[factionid][i] = "Ultramarine Scout"
CF.ActPresets[factionid][i] = "Ultramarine Scout"
...
i = #CF.ActNames[factionid] + 1
CF.ActNames[factionid][i] = "Ultramarine Assault Recon"
CF.ActPresets[factionid][i] = "Ultramarine Assault Recon"
CF.ActModules[factionid][i] = "w40k.rte"
...
i = #CF.ActNames[factionid] + 1
CF.ActNames[factionid][i] = "Ultramarine"
CF.ActPresets[factionid][i] = "Ultramarine"
CF.ActModules[factionid][i] = "w40k.rte"
...
i = #CF.ActNames[factionid] + 1
CF.ActNames[factionid][i] = "Assault Ultramarine"
CF.ActPresets[factionid][i] = "Assault Ultramarine"
CF.ActModules[factionid][i] = "w40k.rte"
...
if CF.BombNames ~= nil then
	...
	CF.BombOwnerFactions[n] = { "Imperium of Man: Ultramarines" }

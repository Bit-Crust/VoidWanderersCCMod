...
-- Faction name
CF_FactionNames[factionid] = "Blood Angels"
-- Faction description
...
-- Define brain unit
CF_Brains[factionid] = "Blood Angels Assault Sergeant Brain"
CF_BrainModules[factionid] = "w40k.rte"
CF_BrainClasses[factionid] = "AHuman"
CF_BrainPrices[factionid] = 500

-- Define dropship
CF_Crafts[factionid] = "Blood Angels Drop Pod"
...
CF_ActNames[factionid][i] = "Blood Angel Scout"
CF_ActPresets[factionid][i] = "Blood Angel Scout"
...
i = #CF_ActNames[factionid] + 1
CF_ActNames[factionid][i] = "Blood Angel Assault Recon"
CF_ActPresets[factionid][i] = "Blood Angel Assault Recon"
CF_ActModules[factionid][i] = "w40k.rte"
...
i = #CF_ActNames[factionid] + 1
CF_ActNames[factionid][i] = "Blood Angels Space Marine"
CF_ActPresets[factionid][i] = "Blood Angels Space Marine"
CF_ActModules[factionid][i] = "w40k.rte"
...
i = #CF_ActNames[factionid] + 1
CF_ActNames[factionid][i] = "Blood Angels Assault Marine"
CF_ActPresets[factionid][i] = "Blood Angels Assault Marine"
CF_ActModules[factionid][i] = "w40k.rte"
...
if CF_BombNames ~= nil then
	...
	CF_BombOwnerFactions[n] = { "Imperium of Man: Blood Angels" }
